...
Client.prototype.unsubscribe = function (eventName, data) {
  var unsub = action('clearSubscribe');
  unsub.eventNames = util.isArray(eventName) ? eventName : [eventName];
  this.send(JSON.stringify(util._extend(unsub, data)));
  return this;
};
